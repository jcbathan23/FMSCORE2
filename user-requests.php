              ...
              <div class="row">
                <div class="col-md-6">
                  <small class="text-muted">
                    ...
                    <span class="peso-icon">₱</span> ${request.final_cost ? 'Final Cost: ' + formatCurrency(request.final_cost) : (request.estimated_cost ? 'Estimated: ' + formatCurrency(request.estimated_cost) : 'Cost: Pending')}
                  </small>
                </div>
              </div>
            </div>
