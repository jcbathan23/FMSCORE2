...
<head>
  ...
  <title>Standard Operating Procedure Manager | CORE II</title>
  <style>
    :root {
      --sidebar-width: 280px;
...
<body>
  ...
  <div class="content" id="mainContent">
    <div class="header">
      ...
      <div>
        <h1>Standard Operating Procedure Manager <span class="system-title">| CORE II </span></h1>
      </div>
    ...
    <div class="mb-4">
      <h3>Standard Operating Procedure (SOP) Manager</h3>
    </div>
    ...
    <div class="row mb-4">
      <div class="col-12">
        <ul class="nav nav-tabs" id="sopTabs" role="tablist">
          ...
          <li class="nav-item" role="presentation">
            <button class="nav-link" id="creation-tab" data-bs-toggle="tab" data-bs-target="#creation" type="button" role="tab">
              <i class="bi bi-plus-circle"></i> SOP Creation
            </button>
          </li>
          <li class="nav-item" role="presentation">
          ...
          <li class="nav-item" role="presentation">
            <button class="nav-link" id="integration-tab" data-bs-toggle="tab" data-bs-target="#integration" type="button" role="tab">
              <i class="bi bi-diagram-3"></i> Integration
            </button>
          </li>
        </ul>
      </div>
    ...
    <div class="tab-content" id="sopTabContent">
      ...
      <div class="tab-pane fade show active" id="overview" role="tabpanel">
        <div class="d-flex justify-content-between align-items-center mb-3">
          <h4>SOP Management Dashboard</h4>
          ...
          <div class="col-md-8">
            <div class="card">
              <div class="card-header">
                <h5><i class="bi bi-plus-circle"></i> SOP Creation & Version Control</h5>
              </div>
              <div class="card-body">
                <div class="row mb-3">
                  <div class="col-md-6">
                    ...
                    <select class="form-select" id="workflowTemplate">
                      ...
                      <option value="booking">Shipment Booking Process</option>
                      <option value="customs">Customs Clearance Process</option>
                      <option value="consolidation">Consolidation Process</option>
                      <option value="deconsolidation">Deconsolidation Process</option>
                      <option value="billing">Billing & Invoice Process</option>
                      <option value="warehouse">Warehouse Operations</option>
                      <option value="documentation">Documentation Process</option>
                      <option value="quality">Quality Control Process</option>
                    </select>
                  </div>
                  <div class="col-md-6">
                    ...
                    <select class="form-select" id="complianceStandard">
                      ...
                      <option value="customs">Government Trade Regulations</option>
                      <option value="internal">Internal Company Standards</option>
                    </select>
                  </div>
                </div>
                <button class="btn btn-primary" onclick="generateSOPTemplate()">Generate SOP Template</button>
                <button class="btn btn-success ms-2" data-bs-toggle="modal" data-bs-target="#sopModal" onclick="openAddModal()">
                  <i class="bi bi-plus-circle"></i> Create Custom SOP
                </button>
              </div>
            </div>
          </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div id="versionHistory">
                  <p class="text-muted">Select an SOP to view version history</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="tab-pane fade" id="compliance" role="tabpanel">
        <div class="row">
          <div class="col-md-6">
            <div class="card">
              <div class="card-header">
                <h5><i class="bi bi-shield-check"></i> Process Compliance Monitoring</h5>
              </div>
              <div class="card-body">
                <div class="mb-3">
                  <h6>Mandatory Step Enforcement</h6>
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="enforceCustomsDocs" checked>
                    <label class="form-check-label" for="enforceCustomsDocs">
                      Customs documents required before shipment release
                    </label>
                  </div>
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="enforceQualityCheck" checked>
                    <label class="form-check-label" for="enforceQualityCheck">
                      Quality inspection before consolidation
                    </label>
                  </div>
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="enforceManagerApproval" checked>
                    <label class="form-check-label" for="enforceManagerApproval">
                      Manager approval for exceptions
                    </label>
                  </div>
                </div>
                <div class="mb-3">
                  <h6>Deviation Alerts</h6>
                  <div class="alert alert-warning" role="alert">
                    <small><i class="bi bi-exclamation-triangle"></i> 3 active deviations requiring attention</small>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-md-6">
            <div class="card">
              <div class="card-header">
                <h6><i class="bi bi-graph-up"></i> Compliance Metrics</h6>
              </div>
              <div class="card-body">
                <div class="row text-center">
                  ...
                  <div class="col-4">
                    <div class="metric-card">
                      ...
                      <div class="metric-label">Audit Reports</div>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div class="tab-pane fade" id="training" role="tabpanel">
        <div class="row">
          <div class="col-md-8">
            <div class="card">
              <div class="card-header">
                <h5><i class="bi bi-mortarboard"></i> Role-Based Access & Training</h5>
              </div>
              <div class="card-body">
                <div class="row mb-3">
                  <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                    ...
                    <select class="form-select" id="trainingModule">
                      <option value="basic">Basic SOP Training</option>
                      <option value="advanced">Advanced Procedures</option>
                ...
                <div class="mb-3">
                  <h6>Interactive Guides Available</h6>
                  <div class="list-group">
                    <a href="#" class="list-group-item list-group-item-action">
                      <i class="bi bi-play-circle"></i> Shipment Booking Checklist
                    </a>
                    <a href="#" class="list-group-item list-group-item-action">
                      <i class="bi bi-play-circle"></i> Customs Documentation Guide
                    </a>
                    <a href="#" class="list-group-item list-group-item-action">
                      <i class="bi bi-play-circle"></i> Quality Control Procedures
                    </a>
                  </div>
                </div>
              </div>
          ...
          <div class="col-md-4">
            <div class="card">
              <div class="card-header">
                <h6><i class="bi bi-person-check"></i> Training Progress</h6>
              </div>
              <div class="card-body">
                ...
                <hr>
                <div class="mb-2">
                  <small><strong>Completed:</strong> 17 modules</small>
                </div>
                <div class="mb-2">
                  <small><strong>In Progress:</strong> 3 modules</small>
                </div>
                <div class="mb-2">
                  <small><strong>Pending:</strong> 2 modules</small>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="tab-pane fade" id="integration" role="tabpanel">
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h5><i class="bi bi-diagram-3"></i> Integration with Operations</h5>
              </div>
              <div class="card-body">
                <div class="row">
                  <div class="col-md-4">
                    <div class="integration-card">
                      ...
                      <h6>Shipment Booking</h6>
                      <p class="small text-muted">SOPs integrated into booking workflow with automated validations</p>
                  ...
                  <div class="col-md-4">
                    <div class="integration-card">
                      ...
                      <h6>Tariff Application</h6>
                      <p class="small text-muted">Pricing SOPs linked to tariff calculation system</p>
                      <span class="badge bg-success">Active</span>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="integration-card">
                      ...
                      <h6>Tracking Workflows</h6>
                      <p class="small text-muted">Status update SOPs integrated with tracking system</p>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <h6>Automated Approvals</h6>
                    <div class="form-check">
                      <input class="form-check-input" type="checkbox" id="autoApprovalExceptions" checked>
                      <label class="form-check-label" for="autoApprovalExceptions">
                        Route exceptions to manager automatically
                      </label>
                    </div>
                    <div class="form-check">
                      <input class="form-check-input" type="checkbox" id="autoApprovalBilling" checked>
                      <label class="form-check-label" for="autoApprovalBilling">
                        Auto-approve standard billing procedures
                      </label>
                    </div>
                  </div>
                  <div class="col-md-6">
  ...
  <script>
    ...
    function loadSOPs() {
      ...
      sops.forEach(sop => {
        const complianceStatus = getComplianceStatus(sop);
        ...
        row.innerHTML = `
          ...
          <td>
            <span class="badge bg-info">${sop.version}</span>
            <button class="btn btn-sm btn-outline-secondary ms-1" onclick="showVersionHistory(${sop.id})" title="Version History">
              <i class="bi bi-clock-history"></i>
            </button>
          </td>
          <td><span class="badge ${getStatusBadgeClass(sop.status)}">${sop.status}</span></td>
          <td><span class="badge ${complianceStatus.class}">${complianceStatus.text}</span></td>
    ...
    // Enhanced SOP Manager Functions
    function getComplianceStatus(sop) {
      // Simulate compliance checking based on SOP properties
      const complianceScore = Math.random();
      if (complianceScore > 0.8) {
        return { class: 'bg-success', text: 'Compliant' };
      } else if (complianceScore > 0.6) {
        return { class: 'bg-warning text-dark', text: 'Review Required' };
      } else {
        return { class: 'bg-danger', text: 'Non-Compliant' };
      }
    }

    function showVersionHistory(sopId) {
      const sop = sops.find(s => s.id === sopId);
      if (!sop) return;

      // Simulate version history data
      const versionHistory = [
        { version: sop.version, date: new Date().toLocaleDateString(), author: 'Admin', changes: 'Current version' },
        { version: '1.1', date: '2024-01-15', author: 'Manager', changes: 'Updated safety protocols' },
        { version: '1.0', date: '2023-12-01', author: 'Admin', changes: 'Initial creation' }
      ];

      const historyHtml = versionHistory.map(v => `
        <div class="border-bottom pb-2 mb-2">
          <div class="d-flex justify-content-between">
            <strong>v${v.version}</strong>
            <small class="text-muted">${v.date}</small>
          </div>
          <div class="small text-muted">By: ${v.author}</div>
          <div class="small">${v.changes}</div>
        </div>
      `).join('');

      document.getElementById('versionHistory').innerHTML = historyHtml;
      
      // Switch to creation tab to show version history
      const creationTab = new bootstrap.Tab(document.getElementById('creation-tab'));
      creationTab.show();
    }

    function generateSOPTemplate() {
      const workflowType = document.getElementById('workflowTemplate').value;
      const complianceStandard = document.getElementById('complianceStandard').value;

      if (!workflowType) {
        showNotification('Please select a workflow template', 'warning');
        return;
      }

      // Generate template based on workflow type
      const templates = {
        booking: {
          ...
          procedures: '1. Verify customer information\n2. Validate shipment details\n3. Check capacity availability\n4. Generate booking confirmation\n5. Send confirmation to customer'
        },
        customs: {
          ...
          procedures: '1. Prepare customs documentation\n2. Submit declarations\n3. Pay duties and taxes\n4. Coordinate inspections\n5. Obtain release authorization'
        },
        consolidation: {
          ...
          procedures: '1. Sort shipments by destination\n2. Verify compatibility\n3. Perform quality checks\n4. Create consolidation manifest\n5. Secure and label consolidated cargo'
        }
      };

      const template = templates[workflowType];
      if (template) {
        // Pre-fill the SOP form with template data
        document.getElementById('sopTitle').value = template.title;
        document.getElementById('sopPurpose').value = template.purpose;
        document.getElementById('sopScope').value = template.scope;
        document.getElementById('sopProcedures').value = template.procedures;
        
        if (complianceStandard) {
          document.getElementById('sopCategory').value = complianceStandard === 'iso9001' ? 'Quality' : 
                                                       complianceStandard === 'iso27001' ? 'Security' : 
                                                       complianceStandard === 'customs' ? 'Compliance' : 'Operations';
        }
        ...
        showNotification('SOP template generated successfully!', 'success');
      }
    }
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      const triggerTabList = [].slice.call(document.querySelectorAll('#sopTabs button'));
