...
// Include authentication and security (session_start is already called in auth.php)
...
<body>
          ...
          <div class="btn-group">
            ...
            <div class="btn-group" role="group">
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="#" onclick="generateReport('summary')">
                  <i class="bi bi-file-text"></i> Summary Report
                </a></li>
                <li><a class="dropdown-item" href="#" onclick="generateReport('suppliers')">
                  <i class="bi bi-building"></i> Suppliers Report
                </a></li>
                <li><a class="dropdown-item" href="#" onclick="generateReport('users')">
                  <i class="bi bi-people"></i> Users Report
                </a></li>
                <li><a class="dropdown-item" href="#" onclick="generateReport('analytics')">
                  <i class="bi bi-graph-up"></i> Analytics Report
                </a></li>
                <li><hr class="dropdown-divider"></li>
                <li><a class="dropdown-item" href="#" onclick="generateReport('comprehensive')">
  ...
  <script>
      ...
      setTimeout(() => {
        ...
        if (reportWindow) {
          Swal.fire({
            ...
            text: 'Your ' + reportType + ' report has been opened in a new window. You can print or save it as PDF.',
            icon: 'success',
    ...
    function downloadPDFReport(reportType) {
      ...
      Swal.fire({
        title: 'Preparing PDF',
        text: 'Generating PDF report for download...',
        icon: 'info',
        allowOutsideClick: false,
        didOpen: () => {
          Swal.showLoading();
      ...
      const downloadUrl = '../../api/generate-report.php?type=' + reportType + '&format=pdf&download=1';
      
      // Create temporary link and trigger download
      const link = document.createElement('a');
      link.href = downloadUrl;
      link.download = 'CORE_II_' + reportType + '_report_' + new Date().toISOString().slice(0,10) + '.pdf';
      ...
      setTimeout(() => {
        Swal.fire({
          ...
          text: 'Your PDF report download should begin shortly.',
          icon: 'success',
          confirmButtonText: 'OK'
        });
      }, 1500);
    ...
    // Add keyboard shortcut for quick report generation
    ...
    // Add report generation to the existing refresh function
