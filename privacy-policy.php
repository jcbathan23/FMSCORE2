...
<body>
  ...
  <?php else: ?>
  <a href="landpage.php" class="btn btn-primary back-button">
  ...
  <div class="container">
    ...
    <div class="privacy-content">
      ...
      <div class="highlight-box">
        ...
        Email: privacy@core2logistics.com<br>
      ...
      <div class="info-box">
        ...
        Email: dpo@core2logistics.com<br>
        Phone: [DPO Phone Number]</p>
      </div>
      ...
      <div class="text-center mt-4 pt-4 border-top">
        ...
        <p class="mt-2">
          <a href="terms-and-conditions.php" class="btn btn-outline-primary btn-sm me-2">
